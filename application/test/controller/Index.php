...
//        return floor($balance*100)/100;
     ...
     * 设置锁
     */
    private function set_mutex($uid, $timeout = 2)
    {
        $cur_time = time();
     ...
     * 释放锁
     */
    private function del_mutex($uid)
    {
        $read_news_mutex_key = "redis:mutex:{$uid}";
        Redis::rm($read_news_mutex_key);
    }
    ...
    public function index()
    {
        ...
        $a = 'MDAwMDAwMDAwMIuiiqaaqZeplp5vqn6hn2ixnLlhs9-FqISfn62yhpzZfq6NcA';
        $b = $this->decry($a,'jiligame');
